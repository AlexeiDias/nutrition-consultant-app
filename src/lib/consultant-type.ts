...
export const CONSULTANT_TYPE_CONFIGS: Record<ConsultantType, ConsultantTypeConfig> = {
  health_coach: {
    ...
    tasksLabel: 'Goals',
    defaultTools: { aiMealPlan: false, mealsBuilder: false, calorieCalculator: true, tasksSection: true },
  },
  nutritionist: {
    label: 'Nutritionist',
    emoji: '🥗',
    ...
    tasksLabel: 'Tasks',
    defaultTools: { aiMealPlan: true, mealsBuilder: true, calorieCalculator: true, tasksSection: true },
  },
  registered_dietician: {
